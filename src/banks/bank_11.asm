...
BattleActionServices_Branch_8A21:
        ...
        brk                                     ; 8A29 00                       .
        db   $E1,$D3,$89,$20,$53,$90,$AD,$44 ; 8A2A E1 D3 89 20 53 90 AD 44  ... S..D
        db   $6E,$09,$03,$8D,$44,$6E         ; 8A32 6E 09 03 8D 44 6E        n...Dn
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; 8AED 00                       .
        db   $45,$93                         ; 8AEE 45 93                    E.
; ----------------------------------------------------------------------------
        ora     ($B0),y                         ; 8AF0 11 B0                    ..
        pha                                     ; 8AF2 48                       H
        brk                                     ; 8AF3 00                       .
        db   $45,$93,$23,$B0,$74,$00,$45,$93 ; 8AF4 45 93 23 B0 74 00 45 93  E.#.t.E.
        db   $24,$B0,$74,$00,$45,$93,$25,$B0 ; 8AFC 24 B0 74 00 45 93 25 B0  $.t.E.%.
        db   $74,$00,$46,$93,$12,$B0,$4E,$00 ; 8B04 74 00 46 93 12 B0 4E 00  t.F...N.
        db   $3B,$93,$03,$90,$04,$C9,$CC,$F0 ; 8B0C 3B 93 03 90 04 C9 CC F0  ;.......
        db   $7C,$38,$60                     ; 8B14 7C 38 60                 |8`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        pha                                     ; 8B3C 48                       H
        brk                                     ; 8B3D 00                       .
        db   $2B,$C3,$14,$B0,$2A,$00,$2B,$C3 ; 8B3E 2B C3 14 B0 2A 00 2B C3  +...*.+.
        db   $15,$B0,$2A,$00,$2B,$C3,$16,$B0 ; 8B46 15 B0 2A 00 2B C3 16 B0  ..*.+...
        db   $2A,$00,$2B,$C3,$17,$B0,$2A,$00 ; 8B4E 2A 00 2B C3 17 B0 2A 00  *.+...*.
        db   $29,$C3,$02,$B0,$36,$38,$60     ; 8B56 29 C3 02 B0 36 38 60     )...68`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        and     #$C3                            ; 8B62 29 C3                    ).
        ora     ($B0),y                         ; 8B64 11 B0                    ..
        db   $04,$00,$E1,$D3,$FA,$18,$60,$00 ; 8B66 04 00 E1 D3 FA 18 60 00  ......`.
        db   $E1,$D3,$E9,$18,$60,$00,$E0,$D3 ; 8B6E E1 D3 E9 18 60 00 E0 D3  ....`...
        db   $24,$18,$60,$00,$E0,$D3,$25,$18 ; 8B76 24 18 60 00 E0 D3 25 18  $.`...%.
        db   $60,$00,$E0,$D3,$26,$18,$60,$00 ; 8B7E 60 00 E0 D3 26 18 60 00  `...&.`.
        db   $E0,$D3,$27,$18,$60             ; 8B86 E0 D3 27 18 60           ..'.`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        rts                                     ; 8B90 60                       `
; ----------------------------------------------------------------------------
        db   $00,$E0,$D3,$14,$38,$60         ; 8B91 00 E0 D3 14 38 60        ....8`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; 8BAA 00                       .
        db   $45,$93                         ; 8BAB 45 93                    E.
; ----------------------------------------------------------------------------
        bpl     BattleActionServices_Branch_8BFB; 8BAD 10 4C                    .L
        cmp     $8B,x                           ; 8BAF D5 8B                    ..
...
; ----------------------------------------------------------------------------
        brk                                     ; 8BB4 00                       .
        db   $69,$93                         ; 8BB5 69 93                    i.
; ----------------------------------------------------------------------------
        bpl     BattleActionServices_Branch_8BB9; 8BB7 10 00                    ..
BattleActionServices_Branch_8BB9:
        cpx     #$D3                            ; 8BB9 E0 D3                    ..
        db   $13,$18,$60                     ; 8BBB 13 18 60                 ..`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; 8BD4 00                       .
        db   $00,$E0,$D3,$12,$18,$60         ; 8BD5 00 E0 D3 12 18 60        .....`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; 8BE1 00                       .
        db   $20,$B8,$8B,$18,$AD,$E9,$72,$30 ; 8BE2 20 B8 8B 18 AD E9 72 30   .....r0
        db   $35,$00,$06,$1F,$00,$2D,$B3,$AA ; 8BEA 35 00 06 1F 00 2D B3 AA  5....-..
        db   $BD,$45,$6E,$A2,$01             ; 8BF2 BD 45 6E A2 01           .En..
; ----------------------------------------------------------------------------
BattleActionServices_Branch_8BF7:
        cmp     $8C47,x                         ; 8BF7 DD 47 8C                 .G.
BattleActionServices_Branch_8BFB = $+ 1
...
; ----------------------------------------------------------------------------
        brk                                     ; 8D81 00                       .
        db   $E8,$D3,$0F,$68,$10,$0A,$29,$07 ; 8D82 E8 D3 0F 68 10 0A 29 07  ...h..).
        db   $AA,$00,$29,$C3,$0E,$B0,$A4,$60 ; 8D8A AA 00 29 C3 0E B0 A4 60  ..)....`
        db   $00,$67,$73,$AA,$00,$46,$93,$07 ; 8D92 00 67 73 AA 00 46 93 07  .gs..F..
        db   $B0,$C2,$60                     ; 8D9A B0 C2 60                 ..`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; 8E7B 00                       .
        db   $62,$D3                         ; 8E7C 62 D3                    b.
; ----------------------------------------------------------------------------
        brk                                     ; 8E7E 00                       .
        db   $20,$53                         ; 8E7F 20 53                     S
; ----------------------------------------------------------------------------
        bcc     BattleActionServices_Branch_8E83; 8E81 90 00                    ..
BattleActionServices_Branch_8E83:
        asl     $2F                             ; 8E83 06 2F                    ./
        rts                                     ; 8E85 60                       `
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; 8EF2 00                       .
        db   $F1,$D3,$8F,$00,$02,$4F,$20,$2E ; 8EF3 F1 D3 8F 00 02 4F 20 2E  .....O .
        db   $BF,$88,$00,$E5,$D3,$90,$60     ; 8EFB BF 88 00 E5 D3 90 60     ......`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; 8F06 00                       .
        db   $E5,$D3,$8F,$00,$02,$4F,$00,$03 ; 8F07 E5 D3 8F 00 02 4F 00 03  .....O..
        db   $4F,$00,$E9,$D3,$91,$60         ; 8F0F 4F 00 E9 D3 91 60        O....`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; 911E 00                       .
        db   $64,$D3,$17,$00,$02,$4F,$00,$07 ; 911F 64 D3 17 00 02 4F 00 07  d....O..
        db   $2F,$00,$27,$0F,$68,$AA,$00,$00 ; 9127 2F 00 27 0F 68 AA 00 00  /.'.h...
        db   $73,$05,$73,$D0,$0A,$20,$72,$92 ; 912F 73 05 73 D0 0A 20 72 92  s.s.. r.
        db   $00,$E8,$D3,$1B,$20,$8A,$93,$60 ; 9137 00 E8 D3 1B 20 8A 93 60  .... ..`
; ----------------------------------------------------------------------------
...
BattleActionServices_Branch_91A4:
        brk                                     ; 91A4 00                       .
        db   $64,$D3                         ; 91A5 64 D3                    d.
; ----------------------------------------------------------------------------
        asl     $68,x                           ; 91A7 16 68                    .h
        tax                                     ; 91A9 AA                       .
        pha                                     ; 91AA 48                       H
...
BattleActionServices_Entry_9272:
        brk                                     ; 9272 00                       .
        db   $45,$93,$07,$00,$27,$0F,$4C,$CF ; 9273 45 93 07 00 27 0F 4C CF  E...'.L.
        db   $92                             ; 927B 92                       .
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; 9AF2 00                       .
        db   $F0,$D3,$23,$AD,$63,$73,$30,$07 ; 9AF3 F0 D3 23 AD 63 73 30 07  ..#.cs0.
        db   $AA,$20,$80,$99,$4C,$08,$9B,$29 ; 9AFB AA 20 80 99 4C 08 9B 29  . ..L..)
        db   $07,$AA,$20,$C0,$99,$4C,$DB,$90 ; 9B03 07 AA 20 C0 99 4C DB 90  .. ..L..
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        tax                                     ; 9B68 AA                       .
        brk                                     ; 9B69 00                       .
        db   $2B,$C3,$0F,$60                 ; 9B6A 2B C3 0F 60              +..`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; 9BBD 00                       .
        db   $66,$D3                         ; 9BBE 66 D3                    f.
; ----------------------------------------------------------------------------
        ora     ($68,x)                         ; 9BC0 01 68                    .h
        tax                                     ; 9BC2 AA                       .
...
; ----------------------------------------------------------------------------
        brk                                     ; 9C06 00                       .
        db   $66,$D3,$02,$00,$02,$4F,$00,$27 ; 9C07 66 D3 02 00 02 4F 00 27  f....O.'
        db   $0F,$00,$07,$2F,$60             ; 9C0F 0F 00 07 2F 60           .../`
; ----------------------------------------------------------------------------
...
BattleActionServices_Branch_A141:
        brk                                     ; A141 00                       .
        db   $E8,$D3,$1A,$18,$60             ; A142 E8 D3 1A 18 60           ....`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ldx     #$07                            ; A2A5 A2 07                    ..
        brk                                     ; A2A7 00                       .
        db   $2B,$C3,$0F,$CA,$10,$F9,$A9,$30 ; A2A8 2B C3 0F CA 10 F9 A9 30  +......0
        db   $8D,$45,$6E,$8D,$46,$6E,$8D,$07 ; A2B0 8D 45 6E 8D 46 6E 8D 07  .En.Fn..
        db   $72,$A9,$00,$AA,$09,$80,$8D,$63 ; A2B8 72 A9 00 AA 09 80 8D 63  r......c
        db   $73,$A9,$01,$85,$7C,$00,$31,$A3 ; A2C0 73 A9 01 85 7C 00 31 A3  s...|.1.
        db   $20,$EF,$A0,$00,$E4,$D3,$41,$AD ; A2C8 20 EF A0 00 E4 D3 41 AD   .....A.
        db   $44,$6E,$09,$03,$8D,$44,$6E,$60 ; A2D0 44 6E 09 03 8D 44 6E 60  Dn...Dn`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; A6C5 00                       .
        db   $70,$D3,$4F,$00,$07,$1F,$20,$F3 ; A6C6 70 D3 4F 00 07 1F 20 F3  p.O... .
        db   $91,$00,$07,$2F,$00,$6D,$D3,$67 ; A6CE 91 00 07 2F 00 6D D3 67  .../.m.g
        db   $38,$60                         ; A6D6 38 60                    8`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; A7A4 00                       .
        db   $E5,$D3,$6B,$68,$68             ; A7A5 E5 D3 6B 68 68           ..khh
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        sta     $F9                             ; A861 85 F9                    ..
        brk                                     ; A863 00                       .
        db   $C5,$D3,$6B,$60                 ; A864 C5 D3 6B 60              ..k`
; ----------------------------------------------------------------------------
BattleActionServices_Branch_A868:
        brk                                     ; A868 00                       .
        db   $E9,$D3,$E7,$60                 ; A869 E9 D3 E7 60              ...`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        tax                                     ; AA81 AA                       .
        brk                                     ; AA82 00                       .
        db   $45,$93                         ; AA83 45 93                    E.
; ----------------------------------------------------------------------------
LAA86 = $+ 1
        ora     $C0C8,y                         ; AA85 19 C8 C0                 ...
        db   $0C,$D0,$D9,$60                 ; AA88 0C D0 D9 60              ...`
; ----------------------------------------------------------------------------
...
BattleActionServices_Entry_AA95:
        ...
        brk                                     ; AAA9 00                       .
        db   $E1,$D3,$89,$00,$0D,$FB         ; AAAA E1 D3 89 00 0D FB        ......
; ----------------------------------------------------------------------------
...
BattleActionServices_Entry_AAB1:
        ...
        ldy     #$F9                            ; AAC5 A0 F9                    ..
        brk                                     ; AAC7 00                       .
        db   $62,$43                         ; AAC8 62 43                    bC
; ----------------------------------------------------------------------------
        eor     ($C9,x)                         ; AACA 41 C9                    A.
        db   $02,$B0,$01,$C8,$A9,$00,$85,$6E ; AACC 02 B0 01 C8 A9 00 85 6E  .......n
        db   $A9,$41,$00,$2D,$0F,$85,$F9,$98 ; AAD4 A9 41 00 2D 0F 85 F9 98  .A.-....
        db   $00,$C1,$E3                     ; AADC 00 C1 E3                 ...
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; ABD2 00                       .
        db   $2B,$C3,$13,$38,$60             ; ABD3 2B C3 13 38 60           +..8`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
LAC29 = $+ 1
        adc     ($E8,x)                         ; AC28 61 E8                    a.
        cpx     #$04                            ; AC2A E0 04                    ..
        bcc     BattleActionServices_Branch_AC1F; AC2C 90 F1                    ..
        brk                                     ; AC2E 00                       .
        db   $E9,$D3,$62,$18,$60             ; AC2F E9 D3 62 18 60           ..b.`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; AC52 00                       .
        db   $2B,$C3,$0B,$60                 ; AC53 2B C3 0B 60              +..`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        db   $C5,$D3                         ; ACFB C5 D3                    ..
; ----------------------------------------------------------------------------
BattleActionServices_Branch_ACFE = $+ 1
        sbc     $18                             ; ACFD E5 18                    ..
        rts                                     ; ACFF 60                       `
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        db   $B2,$D3                         ; AE97 B2 D3                    ..
; ----------------------------------------------------------------------------
        ora     ($4C,x)                         ; AE99 01 4C                    .L
        db   $74,$AE                         ; AE9B 74 AE                    t.
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; AED3 00                       .
        db   $E5,$D3,$A3,$68,$85,$C7,$00,$13 ; AED4 E5 D3 A3 68 85 C7 00 13  ...h....
        db   $4F,$00,$07,$1F                 ; AEDC 4F 00 07 1F              O...
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; AF08 00                       .
        db   $2B,$C3,$03,$00,$2B,$C3,$04,$00 ; AF09 2B C3 03 00 2B C3 04 00  +...+...
        db   $2B,$C3,$05,$00,$2B,$C3,$06,$00 ; AF11 2B C3 05 00 2B C3 06 00  +...+...
        db   $2B,$C3,$07,$00,$2B,$C3,$11,$90 ; AF19 2B C3 07 00 2B C3 11 90  +...+...
        db   $03,$20,$EF,$A0,$00,$E5,$D3,$A2 ; AF21 03 20 EF A0 00 E5 D3 A2  . ......
        db   $60                             ; AF29 60                       `
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; AF64 00                       .
        db   $45,$93,$13,$00,$45,$93,$14,$00 ; AF65 45 93 13 00 45 93 14 00  E...E...
        db   $45,$93,$15,$00,$45,$93,$16,$00 ; AF6D 45 93 15 00 45 93 16 00  E...E...
        db   $45,$93,$17,$00,$45,$93,$18,$90 ; AF75 45 93 17 00 45 93 18 90  E...E...
        db   $03,$20,$EF,$A0,$AD,$E6,$72,$29 ; AF7D 03 20 EF A0 AD E6 72 29  . ....r)
        db   $30,$F0,$12,$AD,$E6,$72,$29,$CF ; AF85 30 F0 12 AD E6 72 29 CF  0....r).
        db   $8D,$E6,$72,$AD,$44,$6E,$29,$FC ; AF8D 8D E6 72 AD 44 6E 29 FC  ..r.Dn).
        db   $09,$01,$8D,$44,$6E,$00,$E5,$D3 ; AF95 09 01 8D 44 6E 00 E5 D3  ...Dn...
        db   $A2,$60                         ; AF9D A2 60                    .`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        rts                                     ; B065 60                       `
; ----------------------------------------------------------------------------
        db   $00,$E5,$D3,$AD,$00,$06,$1F,$AD ; B066 00 E5 D3 AD 00 06 1F AD  ........
        db   $55,$73,$00,$31,$73,$00,$30,$73 ; B06E 55 73 00 31 73 00 30 73  Us.1s.0s
        db   $60                             ; B076 60                       `
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; B089 00                       .
        db   $66,$D3                         ; B08A 66 D3                    f.
; ----------------------------------------------------------------------------
        ora     ($60,x)                       ; B08C 01 60                    .`
BattleActionServices_Branch_B08E:
        bvc     $B09C                           ; B08E 50 0C                    P.
        brk                                     ; B090 00                       .
        db   $05,$3F                         ; B091 05 3F                    .?
; ----------------------------------------------------------------------------
        brk                                     ; B093 00                       .
...
; ----------------------------------------------------------------------------
        brk                                     ; B110 00                       .
        db   $E9,$D3,$A3,$60                 ; B111 E9 D3 A3 60              ...`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; B124 00                       .
        db   $2B,$C3,$0C,$A9,$FF,$85,$7D,$00 ; B125 2B C3 0C A9 FF 85 7D 00  +.....}.
        db   $15,$B3,$00,$19,$A3,$00,$11,$A3 ; B12D 15 B3 00 19 A3 00 11 A3  ........
        db   $00,$13,$A3,$A4,$7F,$84,$7D,$00 ; B135 00 13 A3 A4 7F 84 7D 00  ......}.
        db   $14,$B3,$00,$17,$A3,$A4,$7F,$84 ; B13D 14 B3 00 17 A3 A4 7F 84  ........
        db   $7D,$00,$18,$B3,$00,$0F,$A3,$00 ; B145 7D 00 18 B3 00 0F A3 00  }.......
        db   $10,$B3,$60                     ; B14D 10 B3 60                 ..`
; ----------------------------------------------------------------------------
BattleActionServices_Branch_B150:
        brk                                     ; B150 00                       .
        db   $45,$93,$1C,$A9,$FF,$85,$70,$00 ; B151 45 93 1C A9 FF 85 70 00  E.....p.
        db   $1A,$73,$00,$1E,$73,$00,$16,$73 ; B159 1A 73 00 1E 73 00 16 73  .s..s..s
        db   $00,$17,$53,$A4,$73,$84,$70,$00 ; B161 00 17 53 A4 73 84 70 00  ..S.s.p.
        db   $19,$73,$00,$1B,$53,$A4,$73,$84 ; B169 19 73 00 1B 53 A4 73 84  .s..S.s.
        db   $70,$00,$1D,$73,$00,$12,$53,$00 ; B171 70 00 1D 73 00 12 53 00  p..s..S.
        db   $15,$73,$60                     ; B179 15 73 60                 .s`
; ----------------------------------------------------------------------------
...
LB19E = $+ 1
        eor     #$A9                            ; B19D 49 A9                    I.
        brk                                     ; B19F 00                       .
        db   $8D,$5E,$73,$20,$C3,$96,$90,$0E ; B1A0 8D 5E 73 20 C3 96 90 0E  .^s ....
        db   $00,$07,$1F,$8A,$48,$20,$FE,$91 ; B1A8 00 07 1F 8A 48 20 FE 91  ....H ..
        db   $68,$AA,$00,$2B,$C3,$0F,$EE,$5E ; B1B0 68 AA 00 2B C3 0F EE 5E  h..+...^
        db   $73,$AD,$5E,$73,$C9,$08,$90,$E3 ; B1B8 73 AD 5E 73 C9 08 90 E3  s.^s....
        db   $60                             ; B1C0 60                       `
; ----------------------------------------------------------------------------
BattleActionServices_Branch_B1C1:
        bit     $72E4                           ; B1C1 2C E4 72                 ,.r
        bvs     $B1CB                           ; B1C4 70 05                    p.
        brk                                     ; B1C6 00                       .
        db   $E5,$D3                         ; B1C7 E5 D3                    ..
; ----------------------------------------------------------------------------
LB1CB = $+ 2
        jmp     $0060                           ; B1C9 4C 60 00                 L`.
; ----------------------------------------------------------------------------
        db   $E5,$D3,$4B,$60                 ; B1CC E5 D3 4B 60              ..K`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        db   $F0,$D3                         ; B1EC F0 D3                    ..
; ----------------------------------------------------------------------------
        eor     $1620                           ; B1EE 4D 20 16                 M .
        sta     $DB4C,y                         ; B1F1 99 4C DB                 .L.
        bcc     BattleActionServices_Branch_B1F6; B1F4 90 00                    ..
BattleActionServices_Branch_B1F6:
        sbc     $D3                             ; B1F6 E5 D3                    ..
        eor     $A9,x                           ; B1F8 55 A9                    U.
        db   $03,$8D,$5E,$73,$20,$2E,$BF,$89 ; B1FA 03 8D 5E 73 20 2E BF 89  ..^s ...
        db   $00,$E1,$D3,$56,$20,$C4,$AC,$90 ; B202 00 E1 D3 56 20 C4 AC 90  ...V ...
        db   $03,$20,$DB,$96,$AD,$E7,$72,$29 ; B20A 03 20 DB 96 AD E7 72 29  . ....r)
        db   $60,$D0,$05,$CE,$5E,$73,$D0,$E4 ; B212 60 D0 05 CE 5E 73 D0 E4  `...^s..
        db   $00,$E1,$D3,$57                 ; B21A 00 E1 D3 57              ...W
; ----------------------------------------------------------------------------
...
BattleActionServices_Branch_B25F:
        brk                                     ; B25F 00                       .
        db   $E1,$D3,$47,$00,$06,$1F,$AD,$55 ; B260 E1 D3 47 00 06 1F AD 55  ..G....U
        db   $73,$00,$2E,$73,$AD,$E5,$72,$09 ; B268 73 00 2E 73 AD E5 72 09  s..s..r.
        db   $02,$8D,$E5,$72,$60             ; B270 02 8D E5 72 60           ...r`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; B317 00                       .
        db   $C5,$D3,$63,$18,$60             ; B318 C5 D3 63 18 60           ..c.`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        ldx     #$00                            ; B327 A2 00                    ..
        brk                                     ; B329 00                       .
        db   $2B,$43,$43,$C9,$05,$F0,$07,$E8 ; B32A 2B 43 43 C9 05 F0 07 E8  +CC.....
        db   $E4,$00,$90,$F3                 ; B332 E4 00 90 F3              ....
; ----------------------------------------------------------------------------
BattleActionServices_Branch_B336:
        clc                                     ; B336 18                       .
        rts                                     ; B337 60                       `
; ----------------------------------------------------------------------------
        db   $86,$6E,$00,$2E,$0F,$A5,$72,$85 ; B338 86 6E 00 2E 0F A5 72 85  .n....r.
        db   $00,$AA,$00,$46,$43,$10,$B0,$EE ; B340 00 AA 00 46 43 10 B0 EE  ...FC...
        db   $A5,$00,$38,$60                 ; B348 A5 00 38 60              ..8`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; B388 00                       .
        db   $F1,$D3,$12,$60                 ; B389 F1 D3 12 60              ...`
; ----------------------------------------------------------------------------
BattleActionServices_Branch_B38D:
        brk                                     ; B38D 00                       .
        db   $F1,$D3,$13,$60                 ; B38E F1 D3 13 60              ...`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        db   $BF,$8C,$00,$E4,$D3,$62,$00,$69 ; B3E4 BF 8C 00 E4 D3 62 00 69  .....b.i
        db   $D3,$41,$00,$06,$1F,$90,$0E,$8A ; B3EC D3 41 00 06 1F 90 0E 8A  .A......
        db   $48,$20,$04,$92,$00,$07,$2F,$68 ; B3F4 48 20 04 92 00 07 2F 68  H ..../h
        db   $AA,$00,$2B,$C3,$0F,$60         ; B3FC AA 00 2B C3 0F 60        ..+..`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; B412 00                       .
        db   $E8,$D3                         ; B413 E8 D3                    ..
        db   $07,$68,$AA,$CA,$10,$E9,$60     ; B415 07 68 AA CA 10 E9 60     .h....`
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; B420 00                       .
        db   $F1,$D3,$1C,$20,$C4,$AC,$90,$F2 ; B421 F1 D3 1C 20 C4 AC 90 F2  ... ....
        db   $20,$1D,$B5,$AD,$61,$73,$69,$0A ; B429 20 1D B5 AD 61 73 69 0A   ...asi.
        db   $8D,$61,$73,$4C,$DB,$90         ; B431 8D 61 73 4C DB 90        .asL..
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        brk                                     ; B46B 00                       .
        db   $F1,$D3,$27,$00,$07,$1F,$90,$0A ; B46C F1 D3 27 00 07 1F 90 0A  ..'.....
        db   $00,$29,$C3,$11,$B0,$04,$00,$E5 ; B474 00 29 C3 11 B0 04 00 E5  .)......
        db   $D3,$28                         ; B47C D3 28                    .(
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        db   $E5,$D3                         ; B74D E5 D3                    ..
; ----------------------------------------------------------------------------
        stx     $4C,y                           ; B74F 96 4C                    .L
        db   $57,$B7                         ; B751 57 B7                    W.
; ----------------------------------------------------------------------------
...
BattleActionServices_Branch_B77A:
        ...
        brk                                     ; B77E 00                       .
        db   $2B,$C3,$0F,$4C,$8C,$B7         ; B77F 2B C3 0F 4C 8C B7        +..L..
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
        ...
        db   $1F,$00,$44,$93,$26,$A9,$52,$20 ; B7ED 1F 00 44 93 26 A9 52 20  ..D.&.R
        db   $08,$B8                         ; B7F5 08 B8                    ..
; ----------------------------------------------------------------------------
...
BattleActionServices_Entry_B91C:
        ...
        rts                                     ; B928 60                       `
; ----------------------------------------------------------------------------
        db   $48,$AD,$E4,$72,$29,$CF,$09,$20 ; B929 48 AD E4 72 29 CF 09 20  H..r)..
        db   $8D,$E4,$72,$68,$60             ; B931 8D E4 72 68 60           ..rh`
...
BattleActionServices_Entry_B9C6:
        ...
        rts                                     ; B9CD 60                       `
; ----------------------------------------------------------------------------
        db   $A2,$03,$86,$00,$A2,$FF,$00,$29 ; B9CE A2 03 86 00 A2 FF 00 29  .......)
        db   $C3,$0E,$48,$A5,$00,$00,$2D,$B3 ; B9D6 C3 0E 48 A5 00 00 2D B3  ..H...-.
        db   $68,$25,$7E,$A2,$00,$4A,$90,$01 ; B9DE 68 25 7E A2 00 4A 90 01  h%~..J..
        db   $E8,$C9,$00,$D0,$F8,$8A,$A6,$00 ; B9E6 E8 C9 00 D0 F8 8A A6 00  ........
        db   $9D,$49,$6E,$C6,$00,$10,$DD,$60 ; B9EE 9D 49 6E C6 00 10 DD 60  .In....`
; ----------------------------------------------------------------------------
...
BattleActionServices_Branch_BC3B:
        brk                                     ; BC3B 00                       .
        db   $46,$83                         ; BC3C 46 83                    F.
; ----------------------------------------------------------------------------
        bpl     BattleActionServices_Branch_BC43; BC3E 10 03                    ..
        bcc     BattleActionServices_Branch_BC4B; BC40 90 09                    ..
        inx                                     ; BC42 E8                       .
BattleActionServices_Branch_BC43:
        cpx     $00                           ; BC43 E4 00                    ..
...
; ----------------------------------------------------------------------------
        ...
        stx     $F9                             ; BCBA 86 F9                    ..
        brk                                     ; BCBC 00                       .
        db   $45,$93                         ; BCBD 45 93                    E.
; ----------------------------------------------------------------------------
        bpl     BattleActionServices_Branch_BCC1; BCBF 10 00                    ..
BattleActionServices_Branch_BCC1:
        eor     $93                             ; BCC1 45 93                    E.
        ora     ($00),y                       ; BCC3 11 00                    ..
        eor     $93                             ; BCC5 45 93                    E.
        db   $1B,$00,$45,$93,$23,$00,$45,$93 ; BCC7 1B 00 45 93 23 00 45 93  ..E.#.E.
        db   $24,$00,$45,$93,$25,$00,$CC,$D3 ; BCCF 24 00 45 93 25 00 CC D3  $.E.%...
        db   $2B,$68,$AA,$E8,$E4,$8E,$90,$D9 ; BCD7 2B 68 AA E8 E4 8E 90 D9  +h......
        db   $20,$86,$87,$20,$F7,$A3,$00,$27 ; BCDF 20 86 87 20 F7 A3 00 27   .. ...'
        db   $0F,$AD,$44,$6E,$09,$03,$8D,$44 ; BCE7 0F AD 44 6E 09 03 8D 44  ..Dn...D
        db   $6E,$60                         ; BCEF 6E 60                    n`
; ----------------------------------------------------------------------------
