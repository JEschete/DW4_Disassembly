...
| Detailed range classification | **Structural coverage: 115,579 bytes (22.04%)** | Control-flow conflicts resolved 27/30 (90%); 3 remaining are Ghidra-only static-analysis false positives (Banks $0F, $1D, $1E; trade-off: +6,000 instructions for 3 acceptable artifacts). Operand-byte exclusions resolve 100% of legitimate code boundary issues. | Document remaining 3 false positives and establish framework for future conflict resolution. |
