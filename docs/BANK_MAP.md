...
| `$16` | Dialogue decoder and text/UI services | Verified | 20-entry directory `$8000-$8027`; text-ID selector `$874C`; Huffman decoder `$87A8`; 88 group pointers `$8951`; 64 normal command handlers and ten page-wrap overlaps recovered from `$A5E9-$A734`; variable command data is bounded at `$B03C-$B1C0/$B3A8-$B4B5`. |
